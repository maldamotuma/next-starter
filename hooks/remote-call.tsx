...
import { Box, Button, Dialog, CardHeader, IconButton, Alert, DialogProps, Breakpoint } from "@mui/material";
...
export const useInitialList = <T extends IdentifierProp>(url: string, options?: RequestConfigType): UseInitialList<T> => {
    ...
    const renderDialog = (copy: {
        ...
        <>
            ...
            <Dialog {...bindDialog(pps)} onClose={() => { }} {...(copy.dialogProps && copy.dialogProps)}>
                <CardHeader
