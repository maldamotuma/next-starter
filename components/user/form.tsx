        ...
        <>
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }} id="add-admin">
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={6} id="input-can_blog">
                        <FormControl>
                            <FormLabel id="can_blog-radio">Can Blog</FormLabel>
                            <RadioGroup
                                aria-labelledby="can_blog-radio"
                                defaultValue={user ? user.can_blog ? "can_blog" : "cannot_blog" : "cannot_blog"}
                                name="can_blog"
                            >
                                <FormControlLabel value={"can_blog"} control={<Radio />} label="Authorized to Blog" />
                                <FormControlLabel value={"cannot_blog"} control={<Radio />} label="Not Authorized to Blog" />
                            </RadioGroup>
                        </FormControl>
                    </Grid>
                </Grid>
